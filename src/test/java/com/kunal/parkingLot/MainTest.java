...
public class MainTest
{
	...
	{
		com.kunal.parkingLot.service.ParkingService instance = new ParkingServiceImpl();
	...
	public void testParkingCapacity() throws Exception
	{
		...
		instance.park(parkingLevel, new Car("DL-01-KS-001", new Date()));
		assertEquals("Sorry,CarParkingDoesnotExist", outContent.toString().trim().replace(" ", ""));
		instance.createParkingLot(parkingLevel, 11);
		instance.park(parkingLevel, new Car("DL-01-KS-002", new Date()));
		instance.park(parkingLevel, new Car("DL-01-KS-003", new Date()));
		instance.park(parkingLevel, new Car("DL-01-KS-004", new Date()));
	...
	public void testEmptyParkingLot() throws Exception
	{
		...
		assertTrue("Parking lot not available".equalsIgnoreCase(outContent.toString().trim().replace(" ", "")));
	...
	public void testParkingLotIsFull() throws Exception
	{
		...
		thrown.expect(ParkingException.class);
		thrown.expectMessage(is(ErrorCode.PARKING_NOT_EXIST_ERROR.getMessage()));
		instance.park(parkingLevel, new Car("DL-01-KS-1001", new Date()));
		assertEquals("Sorry,CarParkingDoesnotExist", outContent.toString().trim().replace(" ", ""));
		instance.createParkingLot(parkingLevel, 2);
		instance.park(parkingLevel, new Car("DL-01-KS-1001", new Date()));
		instance.park(parkingLevel, new Car("DL-01-KS-1002", new Date()));
		instance.park(parkingLevel, new Car("DL-01-KS-1003", new Date()));
	...
	public void testNearestSlotAllotment() throws Exception
	{
		...
		instance.park(parkingLevel, new Car("DL-01-KS-1001", new Date()));
		instance.park(parkingLevel, new Car("DL-01-KS-1002", new Date()));
		instance.getSlotNoFromRegistrationNo(parkingLevel, "DL-01-KS-1001");
		instance.getSlotNoFromRegistrationNo(parkingLevel, "DL-01-KS-1002");
	...
	public void leave() throws Exception
	{
		...
		thrown.expect(ParkingException.class);
		thrown.expectMessage(is(ErrorCode.PARKING_NOT_EXIST_ERROR.getMessage()));
		instance.unPark(parkingLevel, "DL-01-KS-1003", 4);
		assertEquals("Sorry,CarParkingDoesnotExist", outContent.toString().trim().replace(" ", ""));
		instance.createParkingLot(parkingLevel, 6);
		instance.park(parkingLevel, new Car("DL-01-KS-1001", new Date()));
		instance.park(parkingLevel, new Car("DL-01-KS-1002", new Date()));
	...
	public void testWhenVehicleAlreadyPicked() throws Exception
	{
		...
		instance.park(parkingLevel, new Car("DL-01-KS-1003", new Date()));
		instance.unPark(parkingLevel, "DL-01-KS-1003", 4);
		instance.unPark(parkingLevel, "DL-01-KS-1002", 4);
		assertTrue(
	...
	public void testGetSlotsByRegNo() throws Exception
	{
		...
		instance.getSlotNoFromRegistrationNo(parkingLevel, "DL-01-KS-1003");
